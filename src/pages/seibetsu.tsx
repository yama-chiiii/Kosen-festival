    ...
    <div className="w-full h-screen flex flex-col items-center bg-pink-base relative">
      ...
      <div className="w-full h-2/3 flex justify-center items-center z-10">
        ...
        <div className="relative flex flex-col justify-center items-center w-1/2">
          ...
          />
          <button
            className="absolute top-[85%] px-20 py-8 bg-pink-dark text-black rounded-xl font-yomogi text-3xl z-10 hover:bg-pink-400"  // ボタンの位置を調整
        ...
        <div className="relative flex flex-col justify-center items-center w-1/2">
          ...
          />
           <button
            className="absolute top-[85%] px-20 py-8 bg-blue-dark text-black rounded-xl font-yomogi text-3xl z-10 hover:bg-blue-400"  // ボタンの位置を調整
